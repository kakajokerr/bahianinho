...
┷┯ ☾ outros comandos ☽
   ...
   ┠❥ *!igStalk [@username]*
   ┠❥ *!anime [nomeDoAnime]*
   ┠❥ *!brainly [questão] [.número]*
   ┠❥ *!loli*
   ┠❥ *!waifu*
   ┠❥ *!husbu* [NomeDoPersonagem]
   ┠❥ *!randomNekoNime*
   ┠❥ *!randomTrapNime*
   ┠❥ *!randomAnime*
   ┠❥ *!info*
   ...
   ┠❥ BOT FEITO: Pc(gitcmd)
   ╿
   ╰╼❥ Obrigado por usar o bot BAHIANINHO. Ele está em fase de testes, pode ser que de uns bugs.`
}
exports.help = help()
function readme() {
    return `
*[linkYt]*  Preencha com um link válido do YouTube sem o sinal “[” e “]”
Contoh : *!ytmp3 https://youtu.be/Bskehapzke8*

*[linkYt]* Preencha com um link válido do YouTube sem o sinal “[” e “]”
Contoh : *!ytmp4 https://youtu.be/Bskehapzke8*

*[linkIg]* Preencha com um link válido do Instagram sem o sinal “[” e “]”
Contoh : *!ig https://www.instagram.com/p/CFqRZTlluAi/?igshid=1gtxkbdqhnbbe*

*[linkFb]* Preencha com um link válido do Facebook sem o sinal “[” e “]”
...
*[@username]* Deve ser preenchido com um nome de usuário válido do Instagram, sem o sinal "[" e "]"
...
*[linkGroup]* Preenchido com um link de grupo Whatsapp válido, sem as marcas "[" e "]".
